...
%------------- BEGIN CODE --------------
    ...
    methods
        ...
        function result = compute(obj, path, differential_s)
...
% Reachability Analysis----------------------------------------------------
            ...
            for i = 0 : state_cells_amount - 1
                % print progress
                disp("current state cell: " + i + "   overall: " + state_cells_amount);
                ...
                for j = 0 : input_grid.total_cells - 1
                    ...
                    powerDyn = nonlinearSys(@differential_s.dyn_eq, ...
